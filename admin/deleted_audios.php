...
<section id="configuration">
              ...
              <tbody>
                ...
                ?>
                      <tr role="row" class="odd">
                        ...
                        <td>
                            <span style="cursor:pointer;color:blue" onclick="restoreAudio('<?php echo base64_encode($audio_id);?>')">Restore</span>
                        </td>
  ...
  <script>
    ...
    function restoreAudio(audioId){
        formData = new FormData();
        formData.append("audio_id",audioId)
        formData.append("restore_audio",1)
