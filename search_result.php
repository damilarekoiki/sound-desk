<?php
    ...
    $s_q=$_GET['s_q'];
    $s_q=preg_replace("#[^0-9a-z]#i","",$s_q);
    $audio_search=$audio_production->search($s_q);
    $user_search=$user->search($s_q);
    $promo_search=$audio_production->search_promo($s_q);
    $channel_search=$channel->search($s_q);

    $all_priced_audios=$audio_production->fetch_all_priced_audios();
    shuffle($all_priced_audios);

    $num_result=count($audio_search)+count($user_search)+count($promo_search)+count($channel_search);
        ...
        <div class="page container" style="margin-top:100px;margin-bottom:70px;" >
            <div class="row col-md-12 play-page" style="">
                <div class="col-md-7">
                    ...
                    <div class="col-md-12">Results found: <?php echo $num_result;?></div>
                    
                    <div class="col-md-12">
                        <?php
                            $pricedCount=0;
                            if(!empty($audio_search)){
                                foreach($audio_search as $priced_audio){
                            ...
                            <?php
                                ...
                                if(!empty($user_search)){
                                    foreach($user_search as $a_user){
                                        $p_pix=$a_user['profile_pix'];
                                        $user_id=$a_user['user_id'];
                                        $name=$a_user['first_name']." ".$a_user['last_name'];
                                        $username=$a_user['username'];
                            ?>
                                        <a href="user_details.php?uid=<?php echo base64_encode($user_id);?>">
                                            <div class="row col-md-12" style="padding-top:8px;margin-top:10px;">
                                                <div id="" class="col-md-2">
                                                    <img src="<?php echo $p_pix;?>" alt="" class="img img-fluid" style="width:100%">
                                                </div>
                                                <div class="col-md-10" style="padding:1px 0px 0px 0px;">
                                                    <div class="row col-md-12">
                                                        <span class="audio-name"><?php echo $name;?></span>
                                                    </div>
                                                    <div class="row col-md-12" style="padding-top:8px;color:black">
                    ...
                    ?>
                            <a href="promo.php?pid=<?php echo base64_encode($promo_id);?>">
                                <div class="row col-md-12" style="padding-top:8px;margin-top:10px;">
                                    <div id="" class="col-md-6">
                                        <img src="<?php echo $audio_cover_pix;?>" alt="" class="img img-fluid" style="width:100%">
                                    </div>
                                    <div class="col-md-6" style="padding:1px 0px 0px 1%;">
                                        <div class="row col-md-12">
                                            <span class="audio-name"><?php echo $promo_code." ";?></span>
                                        </div>
                                        <div class="row col-md-12" style="padding-top:8px;padding-left:0px">
                                            <div id="" class="col-md-4">
                                                <img src="<?php echo $channel_logo;?>" alt="" class="img img-fluid float-right" style="width:100%;height:100%">
                                            </div>
                                            <div id="" class="col-md-8" style="padding-left:0px">
                                                <span class="float-left audio-name"><?php echo $channel_name;?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    if(!empty($channel_search)){
                        foreach($channel_search as $a_channel){
                            $channel_logo=$a_channel['logo'];
                            $channel_name=$a_channel['channel_name'];
                            $channel_id=$a_channel['channel_id'];
                            $owner_id=$a_channel['owner_id'];
