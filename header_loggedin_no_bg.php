...
<nav class="navbar navbar-expand-lg navbar-light fixed-top navbar-dark" id="mainNav">
      <div class="container">
            ...
            <li class="nav-item nav-text">
              ...
              <span style="font-size:9px;"></span></a>
                  <div class="dropdown-menu" araia-labelledby="dropdownMenuButton" style="background:black;">
                      <a href="user_details.php" class="nav-link js-scroll-trigger" href="user_details.php">View Profile</a>
                      <a href="my_channels.php" class="nav-link js-scroll-trigger" href="my_channels.php">My Channels</a>
                      <a href="logout.php?action=1" class="nav-link js-scroll-trigger" href="../logout.php?logout=1">Logout</a>
                  </div>
              </span>
            </li>
